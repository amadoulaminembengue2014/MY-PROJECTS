...
if (!isset($_SESSION['user_name'])) {        #Allow to affich the name registered.
...
<body>
  ...
  color: #333;">
    ...
    <div class="content">
      <h3>hi, <span style="background: crimson;color: #fff;border-radius: 5px;padding: 0 10px;">user</span></h3>
      <h1 style="font-size: 50px;color: #333;">Welcom <span style="color: crimson;"><?php echo $_SESSION['user_name'] ?></span></h1>
      <p style="font-size: 25px;margin-bottom: 20px;">This is an user page</p>
