...
public class BillServiceImpl implements BillService {
	...
	public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
		...
		try {
			...
			return ShopUtils.getResponseEntity("Required data not found", HttpStatus.BAD_REQUEST);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public ResponseEntity<String> deleteBill(Integer id) {
		try {
			...
			if (!optional.isEmpty()) {
				...
				return ShopUtils.getResponseEntity("Bill Deleted Successfully", HttpStatus.OK);
			}
			return ShopUtils.getResponseEntity("Bill id does not exist", HttpStatus.OK);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		return ShopUtils.getResponseEntity(ShopConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
